				...
				<div class="col-lg-12 col-md-12">
					<div class="testimonial-slider">
						<div class="single-testimonial">
							...
							<div class="avatar">
								<img src="static/images/dev1.jpg" alt="testimonial images">
							</div>
						...
						<div class="single-testimonial">
							...
							<div class="avatar">
								<img src="static/images/dev2.jpg" alt="testimonial images">
							</div>
							<div class="testimonial-bio">
								<div class="bio-info">
									<h3>Lana Shelton</h3>
						...
						<div class="single-testimonial">
							...
							<div class="avatar">
								<img src="static/images/dev3.jpg" alt="testimonial images">
							</div>
							<div class="testimonial-bio">
								<div class="bio-info">
									<h3>Mario Houston</h3>
